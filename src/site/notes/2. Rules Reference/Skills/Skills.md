...
Even if you're untrained in [[2. Rules Reference/Skills/Lore\|Lore]], you can use it to [[2. Rules Reference/Encounter/Actions/Basic Actions/Recall Knowledge\|Recall Knowledge]].
